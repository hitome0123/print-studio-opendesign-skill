...
description: "Use to create or review customer-facing commerce display images for Print Studio OpenDesign jobs: white-background product shots, ambiance/lifestyle shots, material preview images, and sales confirmation visuals. Keeps commerce mockups separate from print source files."
---
...
- Show both white-background and ambiance views when the customer needs sales material.

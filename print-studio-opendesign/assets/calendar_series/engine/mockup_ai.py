...
WHITEBG_PROMPT = (
    ...
    "calendar page as a printed surface on the product; preserve the exact "
    "card layout as a flat rectangular printed surface. The whole card must be "
    "visible inside the image frame with all four edges visible. Do not crop, "
    "zoom into, recompose, extend, repaint, relayout, rotate, warp, rewrite or "
    "replace the artwork, month title, keyword, date grid, margins or text from "
    "the reference. Do not invent new text, logos, stickers, labels, props or extra decoration. "
...
AMBIANCE_PROMPT = (
    ...
    "as a printed surface on the product; preserve the exact card layout as a "
    "flat rectangular printed surface. The whole card must be visible inside "
    "the image frame with all four edges visible. Do not crop, zoom into, "
    "recompose, extend, repaint, relayout, rotate, warp, rewrite or replace the "
    "artwork, month title, keyword, date grid, margins or text from the reference. "
    "Do not invent new text, logos, stickers, labels or extra decoration on the card. If tiny "

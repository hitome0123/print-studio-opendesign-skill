...
1. 先提供图片文件夹。
2. 运行交互式项目向导，不用手写 JSON，按提示选择产品、张数、材质、年份。
3. 运行图片优先建议器，从图片本身判断产品、尺寸、材质、排版和字体方向。
4. 先生成材质选择页和 A/B/C 版式候选页。
5. 选中一版后锁版，再批量生成预览、印刷文件、白底图、氛围图、4K 单张下载图。
6. 打开 `交付说明.html`，从一个入口检查和下载所有交付文件。
7. 用 QC 报告判断是否能交付。
